...
import cv2
import time
modellist=["diorshipyolov8s_int8",
"diorshipyolov8n_int8","diorshipyolov8n_float16","diorshipyolov8s_float16"]

modelfolder='yolov8diorship/'
runs = 100
...
def processall(model):
    ...
    for i in range(runs):
        ...
        xyxy, scores = YOLOv8detect(output_data) 
